...
sudo ln -s /root/.ssh/zookeeper_keytabs/zookeeper-quorum3.keytab /etc/krb5.keytab
...
update_node() {
    ...
    kinit -k -t /root/.ssh/zookeeper_keytabs/zookeeper-quorum3.keytab zookeeper-quorum-server/zookeeper-quorum-server3@EXAMPLE.COM

    # Verify the ticket
    klist -c /var/lib/zookeeper/krb5cc/zookeeper-cc_3

    sudo chown root:root /var/lib/zookeeper/krb5cc/zookeeper-cc_3
