...
sudo ln -s /root/.ssh/zookeeper_keytabs/zookeeper-quorum4.keytab /etc/krb5.keytab
...
update_node() {
    ...
    kinit -k -t /root/.ssh/zookeeper_keytabs/zookeeper-quorum4.keytab zookeeper-quorum-learner/zookeeper-quorum-learner4@EXAMPLE.COM

    # Verify the ticket
    klist -c /var/lib/zookeeper/krb5cc/zookeeper-cc_4

    sudo chown root:root /var/lib/zookeeper/krb5cc/zookeeper-cc_4
