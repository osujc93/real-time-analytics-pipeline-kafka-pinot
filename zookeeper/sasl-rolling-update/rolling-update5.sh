...
sudo ln -s /root/.ssh/zookeeper_keytabs/zookeeper-quorum5.keytab /etc/krb5.keytab
...
update_node() {
    ...
    kinit -k -t /root/.ssh/zookeeper_keytabs/zookeeper-quorum5.keytab zookeeper-quorum-learner/zookeeper-quorum-learner5@EXAMPLE.COM

    # Verify the ticket
    klist -c /var/lib/zookeeper/krb5cc/zookeeper-cc_5

    sudo chown root:root /var/lib/zookeeper/krb5cc/zookeeper-cc_5
